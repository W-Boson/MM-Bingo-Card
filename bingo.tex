...
\begin{document}
	...
	\myItems{Cullen get's salty; Luka apologizes; Steve explains the rules wrong; Steve makes a 10+ inch charge; Cullen misfires; Steve cheats as a joke; Combat Wombat!; Nanananana-\\nanananana! Rock Lobster!; forgetting the turn counter; chair of dispair; jonathan kelly deletes his own message; Distraction!; respect my army!;luka comes to late; Gurrrr!; Zaammbies or Skalitaans; Hard Body!; Bosscrows; naming the giant; steve landing under the table; forgetting to vanguard; Like, subscribe and ring that bell for Algorithmo; Happy Birthday Steve!; cyberhunter; presenting the merch; audio overdrive; forgetting animosity; Missreading a donation!; Miscast!}
